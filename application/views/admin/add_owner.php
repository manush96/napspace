<div id="body" class="container-fluid"><div class="col-sm-12">
    ...
    <div class="form-group">
            ...
            <div class="form-group">
            <label class="control-label col-sm-2" for="contact">About owner:</label>
            <div class="col-sm-4">          
                <textarea id="about_owner" rows="5" cols="10" class="form-control" name="about_owner" placeholder="Enter description about owner"></textarea>
            </div>            
        </div>  
